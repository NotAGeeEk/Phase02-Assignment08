    ...
    internal class Employees
    {
        ...
        public void EFRead()
        {
            try
            {
                ...
                {
                    Console.WriteLine("ID: " + e.Employeeld);
        ...
        public void EFInsert()
        {
            try
            {
                ...
                Employee.Employeeld = int.Parse(Console.ReadLine());
                ...
                Employee.Salary = (decimal?)double.Parse(Console.ReadLine());
        ...
        public void EFUpdate()
        {
            try
            {
                ...
                Employee = db.Employees.SingleOrDefault(e => e.Employeeld == id);
